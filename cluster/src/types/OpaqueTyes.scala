...
/**
 * Provides the opaque types for the messaging system elements. This is a way to provide a type-safe
 * way to handle the different elements of the messaging system without exposing the actual type of
 * the elements. This makes the code more robust and less error-prone.
 */
object OpaqueTypes:
