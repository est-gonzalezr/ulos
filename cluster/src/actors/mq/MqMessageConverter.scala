...
/**
 * This actor is responsible for serlializing and deserializing the messages that come from the
 * Message Queue. It is a stateless actor that is instantiated everytime a message is received.
 */
object MqMessageConverter:
   ...
   *
   * @return
   *   A behavior that serializes or deserializes a message and sends it to the MQ Manager.
   */
