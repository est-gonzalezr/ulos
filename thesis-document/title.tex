...
\newcommand{\Author}{Esteban González Ruales}
\newcommand{\MainTitle}{Uniandes Labs Orchestration System: Building a distributed system for distributed and remote task execution}
\newcommand{\SecondaryTitle}{} % If needed
\newcommand{\ShortSecondaryTitle}{} %If needed
\newcommand{\PublicDefenceDate}{25th of November, 2025}
...
\publishers{%
    ...
    \begin{tabularx}{\linewidth}{Xr}
        ...
        Prof. Camilo \textsc{Escobar-Velasquez} (Promotor) & Universidad de los Andes, Colombia \\
        Prof. Reviewer 1 \textsc{Reviewer 1}               & Institution, Country               \\
        Prof. Reviewer 2 \textsc{Reviewer 2}               & Institution, Country               \\
    \end{tabularx}
}
...
tracked in the text and squashed thanks to \textit{Bugs in
