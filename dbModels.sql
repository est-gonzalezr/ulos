...
-- Example
INSERT INTO Task (user_id, task_type_id, remote_storage_path) VALUES (1, 1, '/files/cypress-test.zip');
-- Here the user corresponds to "e.gonzalez5@uniandes.edu.co" and the task type corresponds to "CYPRESS".
