...
-- SysUser table: Contains the user information.
...
-- Example
INSERT INTO SysUser (email, assigned_role) VALUES ('e.gonzalez5@uniandes.edu.co', 'sysadmin');
...
--  Example
INSERT INTO Assignment (class_id, assignment_name) VALUES (1, 'Assignment 1');
...
CREATE TABLE ProcessingStagesByTaskType (
    task_type_id SMALLINT NOT NULL REFERENCES TaskType(id),
    processing_stage_id SMALLINT NOT NULL REFERENCES ProcessingStage(id),
    creation_timestamp TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (task_type_id, processing_stage_id)
);

-- Example
INSERT INTO ProcessingStagesByTaskType (task_type_id, processing_stage_id) VALUES (1, 1);
INSERT INTO ProcessingStagesByTaskType (task_type_id, processing_stage_id) VALUES (1, 2);
-- This means that the task type "CYPRESS" has the processing stage "PARSING" and "EXECUTION".
...
-- ProcessingContainer table: Contains the processing containers that the system uses to process the tasks.
CREATE TABLE ProcessingContainer (
    id SMALLINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Task (
    ...
    user_id INT NOT NULL REFERENCES SysUser(id),
    task_type_id SMALLINT NOT NULL REFERENCES TaskType(id),
    class_id INT NOT NULL REFERENCES Class(id),
...
-- Example
INSERT INTO Task (user_id, task_type_id, class_id, assignment_id, remote_storage_path) VALUES (1, 1, 1, 1, '/files/test.zip');
-- Here the user_id refers to "e.gonzalez5@uniandes.edu.co", the task_type_id refers to "CYPRESS", the class_id refers to "Software Engineering 202510", the assignment_id refers to "Assignment 1".
