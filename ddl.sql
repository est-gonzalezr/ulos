...
-- task_type table: Contains the task types that have been defined in the system.
...
-- Example
-- INSERT INTO task_type (type_name, type_description, created_by) VALUES ('IP_PROJECT_1_202510', 'Evaluate IP project 1.', 1);

-- assignment table: Contains the assignments that have been created in the system.
CREATE TABLE assignment (
    id INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    class_id INT NOT NULL REFERENCES class(id),
    task_type_id SMALLINT NOT NULL REFERENCES task_type(id),
...
-- Example
-- INSERT INTO assignment (class_id, task_type_id, assignment_name, assignment_description, assignment_start_date, assignment_end_date, created_by) VALUES (1, 1, 'Project 1', 'Do IP project 1 and upload for grading.', '2021-10-01 00:00:00', '2021-10-15 23:59:59', 1);
...
-- stage_by_task_type: Contains the processing stages that a task type can have.
CREATE TABLE stage_by_task_type (
    task_type_id SMALLINT NOT NULL REFERENCES task_type(id),
    processing_stage_id SMALLINT NOT NULL REFERENCES processing_stage(id),
    UNIQUE (task_type_id, processing_stage_id)
);

-- Example

-- INSERT INTO stage_by_task_type (task_type_id, processing_stage_id) VALUES (1, 1);
-- INSERT INTO stage_by_task_type (task_type_id, processing_stage_id) VALUES (1, 2);

-- These two inserts mean that the task type with id 1 has the processing stages with id 1 and 2
-- which will correspond to task_type "IP_PROJECT_1_202510" having the stages "PARSING" and "EXECUTION".
...
CREATE TABLE processing_container (
    ...
    created_by INT NOT NULL REFERENCES sys_user(id),
    creation_timestamp TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (task_type_id, processing_stage_id) REFERENCES stage_by_task_type(task_type_id, processing_stage_id)
);

-- Example
-- INSERT INTO processing_container (container_name, container_description, task_type_id, processing_stage_id, remote_storage_path, run_command, created_by) VALUES ('IP_PROJECT_1_PARSING_VALIDATION_202510', 'Container for validating the parsing of IP project 1.', 1, 1, '/container_4820589.tar.gz', NULL, 1);
-- INSERT INTO processing_container (container_name, container_description, task_type_id, processing_stage_id, remote_storage_path, run_command, created_by) VALUES ('IP_PROJECT_1_PARSING_VALIDATION_202510', 'Container for validating the parsing of IP project 1.', 1, 2, '/container_4820590.tar.gz', NULL, 1);
...
-- defined in the 'stage_by_task_type' table.
